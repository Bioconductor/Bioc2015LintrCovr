...
# Future Directions #
  ...
  - Bioconductor linters
    ...
    - camelCase
    - no spaces in arguments (a=b)
  - Lint R code in knitr/Sweave docs
    - Rmd
    - Rnw
  - Improve Performance
    - C/C++ helper utility functions?
  - Robustness linters (@hadley)
    - require() / library() inside functions
    - don't change global state permanently, (`setwd(), options(), par()`) ect.
